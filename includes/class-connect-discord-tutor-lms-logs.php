 ...
 */
class Connect_Discord_Tutor_Lms_Logs {
	function __construct() {
		// Clear all existing logs.
		add_action( 'wp_ajax_ets_tutor_lms_discord_clear_logs', array( $this, 'ets_tutor_lms_discord_clear_logs' ) );
	}
	 ...
	 */
	public static $log_file_name = 'tutor_lms__discord_api_logs.txt';
	 ...
	 * @return None
	 */
	public function ets_tutor_lms_discord_clear_logs() {
...
new Connect_Discord_Tutor_Lms_Logs();
